...
# -- SerpApi --
# API key for SerpApi Google News search
...
# LLM temperature for animation generation (higher = more creative visuals)
ANIMATION_TEMPERATURE: float = float(get_env("ANIMATION_TEMPERATURE", "0.8"))
